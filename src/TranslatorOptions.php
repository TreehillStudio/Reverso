...
class TranslatorOptions
{
    ...
    /**
     * Base URL of Reverso API, can be overridden for example for testing purposes.
    ...
    /** The default server URL used for Reverso API Pro accounts (if SERVER_URL is unspecified). */
    public const DEFAULT_SERVER_URL = 'https://api.translation.ent.reverso.net/ri6/riws/Services/RestTranslation.svc';
